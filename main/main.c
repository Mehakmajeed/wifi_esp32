...
// Create an instance of esp_netif_t for the AP
...
// Apply the IP information to the AP
esp_netif_dhcps_stop(ap_netif);
esp_netif_set_ip_info(ap_netif, &ip_info);
esp_netif_dhcps_start(ap_netif);

// The MAC address is set in the Wi-Fi initialization code
// using the esp_wifi_set_mac function
